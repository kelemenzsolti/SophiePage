...
const socialLinks = [
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/czarth.zsofia/',
    icon: (
  ...
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/csengezsofia.czarth.3',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/czarthcsengezsofia/',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        ...
        >
          <div className="lg:col-span-2">
            <p className="font-serif text-2xl font-medium">{t.nav.logo}</p>
            ...
            <div className="mt-5 flex gap-3">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-cream/15 text-cream/70 transition-all hover:border-terracotta hover:bg-terracotta hover:text-cream"
                >
                  {link.icon}
                </a>
              ))}
