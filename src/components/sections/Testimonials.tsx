        ...
        <div className="overflow-hidden rounded-[1.75rem] border border-charcoal/5 bg-cream/80 p-8 shadow-card backdrop-blur-sm md:p-12">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="font-serif text-xl leading-relaxed text-charcoal md:text-2xl">
          ...
          <div className="mt-10 flex items-center justify-center gap-4">
            <button
              ...
              className="flex h-11 w-11 items-center justify-center rounded-full border border-charcoal/10 text-charcoal transition-colors hover:border-terracotta/30 hover:text-terracotta"
            >
        ...
        <div className="mt-10 hidden gap-6 md:grid md:grid-cols-2">
          {items.map((item, index) => (
            ...
            >
              ...
              <p className="mt-4 text-xs font-medium text-olive">{item.role}</p>
            </motion.div>
          ))}
        </div>
      </div>
